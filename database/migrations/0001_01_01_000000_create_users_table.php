...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('uid')->nullable()->unique(); // public shareable account ID; generated by User model
            ...
            $table->string('image')->nullable();  // uploaded profile picture (public disk)
