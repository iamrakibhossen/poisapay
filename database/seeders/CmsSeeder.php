...
HTML,
            ...
            [
                ...
                'meta_description' => 'The terms and conditions that govern your use of PaishaPay.',
                'content' => <<<'HTML'
<p>By creating an account and using PaishaPay, you agree to these Terms of Service. Please read them carefully.</p>
<h2>1. Eligibility</h2>
<p>You must be at least 18 years old and a resident of a jurisdiction where PaishaPay is available. You agree to provide accurate information and to complete identity verification when required.</p>
...
<p>You may not use PaishaPay for money laundering, fraud, or any unlawful activity. We reserve the right to suspend or close accounts that violate these terms or applicable law.</p>
...
<h2>5. Liability</h2>
<p>PaishaPay is provided on an "as is" basis. To the fullest extent permitted by law, we are not liable for losses arising from market movements, network delays, or events beyond our reasonable control.</p>
HTML,
            ],
            [
                'slug' => 'privacy',
                'title' => 'Privacy Policy',
                'meta_description' => 'How PaishaPay collects, uses, and protects your personal information.',
                'content' => <<<'HTML'
<p>This Privacy Policy explains how PaishaPay collects, uses, and protects your personal information.</p>
...
HTML,
            ...
            [
                ...
                'meta_description' => 'PaishaPay legal centre — Terms of Service, Privacy Policy, AML & KYC Policy, and our compliance approach.',
                'content' => <<<'HTML'
<p>This page brings together the policies that govern your use of PaishaPay. Use the footer links to jump to a section. These policies may be updated from time to time; we will notify you of material changes through the app or by email.</p>

<h2 id="terms">Terms of Service</h2>
<p>By creating an account and using PaishaPay, you agree to these Terms of Service. Please read them carefully, together with the Privacy and AML &amp; KYC policies below.</p>
<h3>1. Eligibility</h3>
<p>You must be at least 18 years old and a resident of a jurisdiction where PaishaPay is available. You agree to provide accurate, current information and to complete identity verification when required.</p>
...
<p>You may not use PaishaPay for money laundering, terrorist financing, fraud, sanctions evasion, or any unlawful activity. We may suspend, restrict, or close accounts that violate these terms or applicable law.</p>
...
<p>PaishaPay is committed to preventing money laundering and the financing of illegal activity. We maintain a risk-based anti-money-laundering (AML) programme and cooperate with lawful requests from competent authorities.</p>
<h3>Know Your Customer</h3>
<p>Identity verification (KYC) is required to open and operate a PaishaPay account. We collect and verify identity information such as your name, date of birth, address, and government-issued identification. Higher limits and certain features may require additional verification tiers.</p>
<h3>Monitoring</h3>
...
<p>PaishaPay operates as a custodial platform and applies KYC/AML controls, transaction monitoring, and risk-based limits in line with applicable regulations in the jurisdictions we serve.</p>
...
HTML,
            ...
            [
                ...
                'meta_description' => 'How PaishaPay prevents money laundering and verifies customer identity (AML & KYC).',
                'content' => <<<'HTML'
<p>PaishaPay is committed to preventing money laundering, terrorist financing, and financial crime. This AML &amp; KYC Policy explains the controls we apply to every account.</p>
...
HTML,
            ...
            [
                'slug' => 'compliance',
                'title' => 'Compliance',
                'meta_description' => 'PaishaPay’s regulatory compliance framework, governance, and how to reach our compliance team.',
                'content' => <<<'HTML'
<p>Compliance is central to how PaishaPay operates. We build our products to meet applicable financial-services, data-protection, and consumer-protection obligations.</p>
<h2>Our framework</h2>
...
HTML,
        ...
        $faqs = [
            ...
            [
                ...
                'answer' => 'Peer-to-peer transfers between PaishaPay users are free. Deposits, withdrawals, and exchanges may carry a small network or spread fee, which is always shown transparently before you confirm the transaction.',
                'group' => 'Fees',
                'sort_order' => 40,
                'show_on_homepage' => true,
            ],
            ...
            [
                ...
                'answer' => 'If you hold USDT on several networks, PaishaPay shows and spends it as a single pooled balance. The network only matters at the moment you deposit or withdraw on-chain.',
                'group' => 'Wallet',
                'sort_order' => 100,
            ],
            [
            ...
            [
                ...
                'answer' => 'Yes. Sending to another PaishaPay user is instant and fee-free because it settles on our internal ledger rather than on-chain.',
                'group' => 'Wallet',
                'sort_order' => 110,
            ],
            [
                'question' => 'What are the deposit and withdrawal fees?',
                'answer' => 'Deposits are free. Withdrawals carry a small percentage platform fee, shown before you confirm — PaishaPay absorbs the network gas cost.',
                'group' => 'Wallet',
                'sort_order' => 115,
            ],
            [
            ...
            [
                ...
                'answer' => 'It draws from your PaishaPay stablecoin balance and converts your asset to the merchant\'s currency at the point of sale, so you can spend crypto without pre-converting it.',
                'group' => 'Cards',
                'sort_order' => 210,
            ],
            [
            ...
            [
                ...
                'answer' => 'Instant. They settle to your PaishaPay balance the moment you confirm, on our internal ledger — there is no on-chain wait.',
                'group' => 'Exchange',
                'sort_order' => 310,
            ],
            [
            ...
            [
                ...
                'answer' => 'Instantly. When a customer pays, the net amount settles straight to your PaishaPay wallet on our internal ledger — there is no multi-day payout or bank delay.',
                'group' => 'Merchant Pay',
                'sort_order' => 405,
            ],
            [
            ...
            [
                ...
                'answer' => 'Payments settle straight to your PaishaPay balance — no external gateway. Earnings can be held for the buyer\'s refund window and then released automatically to your spendable balance, so refunds never leave you in the negative.',
                'group' => 'Selling on Shop',
                'sort_order' => 510,
            ],
            [
                'question' => 'How do buyers pay at checkout?',
                'answer' => 'Every checkout supports three rails: a PaishaPay wallet balance, a card, or crypto. Buyers pick whichever they have — you receive your settlement asset either way.',
                'group' => 'Selling on Shop',
                'sort_order' => 515,
            ],
            [
