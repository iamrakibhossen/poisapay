    ...
    public function run(): void
    {
        ...
        if ($bdt) {
            ...
            $this->method($bdt->id, 'City Bank', 'bank', 2, [
                'account_holder' => 'PaishaPay Ltd', 'bank_name' => 'City Bank', 'account_number' => '1234567890', 'branch' => 'Gulshan', 'routing_number' => '225261729',
            ], 'Transfer to the account above and enter the bank reference number.', '100000', null);
        }

        if ($usd) {
            $this->method($usd->id, 'Wire transfer', 'bank', 0, [
                'account_holder' => 'PaishaPay Ltd', 'bank_name' => 'Standard Chartered', 'account_number' => 'US00-1234-5678', 'swift' => 'SCBLUS33',
