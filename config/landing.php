...
return [
    ...
    'products' => [
        ...
        'exchange' => [
            ...
            'title' => 'Swap crypto in seconds',
            'lead' => 'Convert between any crypto — stablecoins and native coins — at live market rates with the spread shown up front. You lock a quote, confirm, and it settles to your balance instantly — no order books, no slippage, no surprises.',
            'highlights' => [
                'Live market rates',
                'Spread shown before you confirm',
                'Instant on-ledger settlement',
                'Crypto ↔ crypto, any pair',
            ],
            'features' => [
                ...
                ['icon' => 'arrows-right-left', 'title' => 'Crypto ↔ crypto', 'desc' => 'Move seamlessly between stablecoins and native coins — USDT, USDC, ETH, BNB and more — in any direction.'],
            ],
            'grid' => [
                'eyebrow' => 'Any direction',
                'title' => 'What you can swap',
                'lead' => 'Convert across stablecoins and native crypto — all inside your wallet.',
                'items' => [
                    ['icon' => 'currency-dollar', 'name' => 'Stablecoin ↔ stablecoin', 'desc' => 'Move between USDT and USDC at tight spreads.'],
                    ['icon' => 'arrow-path', 'name' => 'Stablecoin ↔ crypto', 'desc' => 'Swap USDT into ETH, BNB and other assets.'],
                    ['icon' => 'arrows-right-left', 'name' => 'Crypto ↔ crypto', 'desc' => 'Rebalance directly between digital assets.'],
                    ['icon' => 'arrow-trending-up', 'name' => 'Native ↔ native', 'desc' => 'Swap directly between ETH, BNB, TRX and more.'],
                    ['icon' => 'scale', 'name' => 'Per-pair pricing', 'desc' => 'Each pair carries its own transparent spread.'],
                    ['icon' => 'credit-card', 'name' => 'Powers card spend', 'desc' => 'The same engine converts crypto to fiat at the point of sale — card only.'],
                ],
            ],
            'steps' => [
            ...
            'faqs' => [
                ...
                ['q' => 'Can I swap between crypto and fiat?', 'a' => 'No — the Exchange is crypto-to-crypto only. You can swap any crypto for another (stablecoins and native coins), but fiat balances aren’t manually swappable. Fiat is used for card spending and settlement, where your crypto auto-converts at the point of sale.'],
        ...
        'p2p' => [
            'eyebrow' => 'P2P',
            'icon' => 'users',
            'title' => 'Buy & sell USDT, peer-to-peer',
            'lead' => 'Trade USDT directly with other people at the price you choose, paying with your local payment methods. Every trade is protected by on-ledger escrow — the seller’s USDT is locked the moment an order opens and only releases once payment is confirmed. Take the best price in a tap, or post your own ad.',
            'cta' => ['label' => 'Open the marketplace', 'route' => 'register'],
            'highlights' => [
                'Escrow-protected trades',
                'Your price, your payment method',
                'Live order matching',
                'Ratings & dispute resolution',
            ],
            'features' => [
                ['icon' => 'lock-closed', 'title' => 'Escrow protection', 'desc' => 'The seller’s USDT is held in escrow on our ledger the moment an order opens, and only releases to the buyer once payment is confirmed — neither side can be short-changed.'],
                ['icon' => 'bolt', 'title' => 'Instant matching', 'desc' => 'Quick-trade matches your amount to the best available ad by price and reputation and opens an escrow order in one tap — no haggling.'],
                ['icon' => 'banknotes', 'title' => 'Local payment methods', 'desc' => 'Pay and get paid with the methods you already use — bank transfer, mobile money and more — agreed up front on every ad.'],
                ['icon' => 'star', 'title' => 'Ratings & reputation', 'desc' => 'Every counterparty carries a completion rate and reviews, and the strongest merchants rise to the top of the book.'],
                ['icon' => 'chat-bubble-left-right', 'title' => 'Disputes handled', 'desc' => 'If something goes wrong, open a dispute with notes and evidence — our team reviews the escrow and resolves it fairly.'],
                ['icon' => 'signal', 'title' => 'Live marketplace', 'desc' => 'Ads and prices update in real time, so you always see the current best offer to buy or sell.'],
            ],
            'grid' => [
                'eyebrow' => 'Two ways to trade',
                'title' => 'Take a price or make one',
                'lead' => 'Jump on the best offer, or post your own ad and set your terms.',
                'items' => [
                    ['icon' => 'arrow-down-tray', 'name' => 'Buy USDT', 'desc' => 'Pay a seller in your local currency and receive USDT from escrow.'],
                    ['icon' => 'arrow-up-tray', 'name' => 'Sell USDT', 'desc' => 'Lock your USDT in escrow and get paid to your account.'],
                    ['icon' => 'megaphone', 'name' => 'Post an ad', 'desc' => 'Set your price, limits and payment methods as a maker.'],
                    ['icon' => 'bolt', 'name' => 'Quick trade', 'desc' => 'Auto-match to the best ad and open an order instantly.'],
                    ['icon' => 'heart', 'name' => 'Favourites & blocks', 'desc' => 'Save trusted traders and hide the ones you’d rather avoid.'],
                    ['icon' => 'shield-check', 'name' => 'Escrow every time', 'desc' => 'Funds stay protected until the trade completes.'],
                ],
            ],
            'steps' => [
                ['icon' => 'magnifying-glass', 'title' => 'Find an offer', 'desc' => 'Browse the marketplace or quick-trade to the best price for your amount.'],
                ['icon' => 'lock-closed', 'title' => 'Order opens in escrow', 'desc' => 'The seller’s USDT is locked on our ledger the moment the order is placed.'],
                ['icon' => 'banknotes', 'title' => 'Pay off-platform', 'desc' => 'Send payment with the agreed method and mark the order paid.'],
                ['icon' => 'check-circle', 'title' => 'Escrow releases', 'desc' => 'Once the seller confirms payment, the USDT releases to the buyer instantly.'],
            ],
            'faqs' => [
                ['q' => 'How does escrow protect me?', 'a' => 'When an order opens, the seller’s USDT is locked in escrow on our internal ledger. It can only release to the buyer after the seller confirms payment was received — so the coins are never exposed while a trade is in progress.'],
                ['q' => 'How do I pay the other person?', 'a' => 'Payment happens off-platform using the method on the ad — bank transfer, mobile money and others. You mark the order paid, and the seller releases the escrow once the funds arrive.'],
                ['q' => 'What if there’s a problem?', 'a' => 'Either side can open a dispute with notes and evidence. Our team reviews the escrow and the trade history and resolves it — the locked funds stay protected until it’s settled.'],
                ['q' => 'Who sets the price?', 'a' => 'Makers post ads at their own price with minimum and maximum limits and accepted payment methods. Takers pick the best offer, or use quick-trade to auto-match by price and reputation.'],
                ['q' => 'Is there a fee?', 'a' => 'A small taker fee applies on completed trades and is always shown before you confirm. Posting an ad is free.'],
            ],
        ],
        'shop' => [
            'eyebrow' => 'Shop',
        ...
        'merchant-pay' => [
            ...
            'icon' => 'building-storefront',
            'title' => 'Get paid in USD, EUR, GBP or BDT',
            'lead' => 'Send a payment request and get paid in your currency — USD, EUR, GBP or BDT. Every payment settles straight to your PaishaPay wallet the moment it clears — a flat 1% fee, no chargebacks, and a webhook for every paid invoice. Approval is instant, so you can start charging today.',
            'cta' => ['label' => 'Start accepting', 'route' => 'merchant'],
            'highlights' => [
                'Charge in USD, EUR, GBP or BDT',
                'Settles instantly to your wallet',
                'Flat 1% per payment',
                'No chargebacks, ever',
            ],
            'features' => [
                ['icon' => 'document-text', 'title' => 'Payment requests', 'desc' => 'Create an invoice in seconds, share the link or show a QR — the customer pays and it settles in your currency.'],
                ...
                ['icon' => 'banknotes', 'title' => 'Flat 1% fee', 'desc' => 'One simple processing fee per payment. No setup cost, no monthly fee, no per-currency surcharge.'],
                ['icon' => 'shield-check', 'title' => 'No chargebacks', 'desc' => 'Payments are final once they settle on our ledger, so you keep what you earn — no fraud reversals weeks later.'],
            ...
            'grid' => [
                ...
                'items' => [
                    ...
                    ['icon' => 'globe-alt', 'name' => 'Multi-currency', 'desc' => 'Charge in USD, EUR, GBP or BDT.'],
            ...
            'steps' => [
                ...
                ['icon' => 'wallet', 'title' => 'Customer pays', 'desc' => 'They pay your request and it settles in your currency.'],
            ...
            'faqs' => [
                ...
                ['q' => 'Which currencies can I charge in?', 'a' => 'USD, EUR, GBP and BDT. You pick the currency on each payment request and receive your settlement in that same fiat currency.'],
                ['q' => 'Are there chargebacks?', 'a' => 'No. Once a payment settles on our internal ledger it is final, so you are protected from the fraud reversals common with card payments.'],
