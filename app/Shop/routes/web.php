...
use App\Shop\Http\Controllers\Admin\RefundReviewController;
use App\Shop\Http\Controllers\Admin\SellerReviewController;
use App\Shop\Http\Controllers\CheckoutController;
use App\Shop\Http\Controllers\ProductController;
use App\Shop\Http\Controllers\PublicPageController;
use App\Shop\Http\Controllers\RefundRequestController;
use App\Shop\Http\Controllers\SalesPageController;
use App\Shop\Http\Controllers\SellerApplicationController;
use Illuminate\Support\Facades\Route;

/*
 * Sell module routes (loaded by ShopServiceProvider). REST, versioned-ready.
