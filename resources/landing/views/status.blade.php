<x-landing::layouts.master :title="__('System Status')" :description="__('Live operational status of PoisaPay services.')">
    @php
    ...
    <div class="mx-auto max-w-3xl px-4 pb-24 pt-14 sm:px-6 sm:pt-20">
        ...
        {{-- Overall banner --}}
        <div class="lp-card flex items-center gap-4 p-6 ring-1 {{ $b['ring'] }}">
        ...
        {{-- Component list --}}
        <div class="lp-card mt-6 divide-y divide-slate-100 p-2 sm:p-3">
