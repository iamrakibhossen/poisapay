...
<section id="{{ $node->id }}" class="pp-block border-t border-neutral-100 py-16 text-center">
    <div class="mx-auto max-w-xl px-5">
        ...
        <p class="mt-4 inline-flex items-center gap-1.5 text-[11px] text-neutral-400"><x-heroicon-o-lock-closed class="h-3.5 w-3.5" /> {{ __('Secure checkout with your PaishaPay wallet') }}</p>
    </div>
</section>
