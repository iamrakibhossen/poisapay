<x-layouts.admin :title="__('Feature Flags')">
    <div class="space-y-6">
        <x-ui.page-header :title="__('Feature Flags')" :subtitle="__('Toggle platform modules and controls. Changes take effect immediately.')" />
