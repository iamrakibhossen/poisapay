<x-admin.form-layout title="Localization" description="Default language and the locales users can choose from." class="!my-0">
    <form class="space-y-5" method="POST" action="{{ route('admin.settings.update', 'localization') }}">
        ...
        <x-admin.input.group id="default_locale" label="Default Locale" required class="w-full" hints="The language new users get by default (e.g. en, bn).">
        ...
        <x-admin.input.group id="available_locales" label="Available Locales" class="w-full" hints="Comma-separated locale codes users can switch between (e.g. en, bn).">
