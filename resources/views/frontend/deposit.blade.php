                    ...
                    <div class="mt-6 border-t border-neutral-100 pt-6">
                        @if ($custodySimulated)
                            <x-ui.alert type="danger" :title="__('Demo / testnet — do not send real funds')" class="mb-5">
                                {{ __('This is a simulated address for testing PaishaPay. The platform does not hold its private key; real funds sent here will be lost.') }}
                            </x-ui.alert>
                        @endif
            ...
            @elseif ($selectedMethod)
                ...
                <x-ui.card>
                    ...
                    @if ($isCrypto)
                        @if ($custodySimulated)
                            <x-ui.alert type="danger" :title="__('Demo / testnet — do not send real funds')" class="mb-5">
                                {{ __('This is a simulated address for testing PaishaPay. Real funds sent here will be lost.') }}
                            </x-ui.alert>
                        @endif
                        @include('frontend.partials.deposit-address')
                    @else
