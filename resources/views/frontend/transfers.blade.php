        ...
        @if ($transfers->total())
                ...
                <table class="min-w-full text-sm">
                    <thead>
                        <tr class="border-b border-neutral-200 bg-neutral-50/60 text-[11px] uppercase tracking-wider text-neutral-400">
                            ...
                            <th class="px-5 py-3 text-left font-semibold">{{ __('Transfer') }}</th>
                            <th class="px-5 py-3 text-left font-semibold">{{ __('Memo') }}</th>
            ...
            @if ($transfers->hasPages())
                <div class="flex items-center justify-between text-sm">
                    ...
                    @endif
                    <span class="text-neutral-500">{{ __('Page :page of :last', ['page' => $transfers->currentPage(), 'last' => $transfers->lastPage()]) }}</span>
