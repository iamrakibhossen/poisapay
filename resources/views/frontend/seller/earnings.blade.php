<x-layouts.app :title="__('Earnings')">
    <div class="mt-6 space-y-5">
        ...
        <x-ui.alert type="info" :title="__('How payouts work')">
            {{ __('Every sale credits your net earnings (after platform fees) straight to your PaishaPay wallet. Amounts stay Pending during the buyer’s refund window, then become Available — withdraw them to your bank or crypto wallet anytime.') }}
        </x-ui.alert>
