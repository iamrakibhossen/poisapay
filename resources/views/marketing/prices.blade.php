<x-layouts.marketing :title="__('Live Prices')" :description="__('Live crypto prices, refreshed every minute.')">
            ...
            @foreach ($coins as $sym => $name)
                <div class="glass-card flex items-center gap-4 p-5">
                    ...
                    <div class="shrink-0 text-right">
                        <p class="tabular text-lg font-bold text-slate-900" data-price data-sym="{{ $sym }}">{{ $symbol }}{{ number_format((float) ($rates[$sym] ?? 0), 2) }}</p>
