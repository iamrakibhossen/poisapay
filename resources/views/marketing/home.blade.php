...
<div class="relative z-10 min-h-full">
    ...
    <section id="prices" class="relative px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
        ...
        <div class="mx-auto max-w-6xl">
            ...
            <div class="reveal mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3" data-price-grid data-rates-url="{{ route('marketing.rates') }}" data-fiat-symbol="{{ $priceSymbol }}">
                @foreach ($priceCoins as $sym)
                    <a href="{{ route('marketing.prices') }}" class="glass glass-hover flex items-center gap-4 rounded-2xl p-5">
                        ...
                        <div class="shrink-0 text-right">
                            <p class="tabular text-base font-bold text-slate-900" data-price data-sym="{{ $sym }}">{{ $priceSymbol }}{{ number_format((float) ($liveRates[$sym] ?? 0), 2) }}</p>
